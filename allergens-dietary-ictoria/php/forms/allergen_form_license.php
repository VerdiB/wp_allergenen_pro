...
class Allergens_Dietary_Ictoria_License_Form implements I_Allergens_Dietary_Ictoria_Form {
	...
	public function showForm( string $allergenName = null ) {
		...
		$html  = '<fieldset>
		<label for="license_key">' . __( 'License keyugg', 'allergens-dietary-ictoria' ) . '</label><br>
		<input type="text" name="license_key" id="license_key" value="">' . _( 'License ke', 'allergens-dietary-ictoria' ) . '<br><br>
