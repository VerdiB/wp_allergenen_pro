...
class Allergens_Dietary_Ictoria_Update_Allergen_Form implements I_Allergens_Dietary_Ictoria_Form
{
    ...
    public function showForm(?string $allergenName = null)
    {
        ...
        foreach ($allergens as $allergen) {
            ...
            // $html .= '';
            $html .= '<td><input type="file" name="allergen_icon[' . esc_attr($allergen->allergy_name) . ']" id="allergen_icon_' . esc_attr($allergen->allergy_name) . '" > </td>';
            // $html .= '';
            $html .= '</tr>';
        }
        ...
        $html .= '</tbody>';
        $html .= '</table>';
        $html .= '<input type="submit" value="' . __('Update Icons', 'allergens-dietary-ictoria') . '">';
