...
class Allergens_Dietary_Pro_Products {
	...
	public function show_product_options(): void {
		global $post;
		$html    = '';
		$allergen_list    = Allergens_Dietary_Pro_Allergy_Product_Queries::getInstance()->getAllergyProduct( $post->ID );
	...
	public function render_html( array $data ): string {
		$html = array();
		$attachments_instance = Allergens_Dietary_Pro_Allergy_Attachment_Queries::getInstance();
