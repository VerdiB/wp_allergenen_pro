...
class Allergens_Dietary_Pro_Activator
{
	...
	{
		self::$_url = get_home_url() . '/wp-content/plugins/allergens-dietary-pro/assets/icons/';
	...
	public static function load_textdomain() {
		load_plugin_textdomain( __( 'allergens-dietary-pro', 'allergens-dietary-pro' ), false, basename( ALLERGENS_DIETARY_PRO_FILE ) . '/l10n' );
	}
	...
	public static function enqueue_styles() {
		wp_enqueue_style( 'allergens-dietary-pro-css', plugins_url( 'assets/css/allergens-dietary-pro.css', ALLERGENS_DIETARY_PRO_FILE ) );
	}

	public static function enqueue_admin_styles() {
		// wp_enqueue_style('allergens-dietary-pro-admin-css', plugins_url('assets/css/allergens-dietary-pro-admin.css', ALLERGENS_DIETARY_PRO_FILE));
	...
	public static function enqueue_admin_scripts() {
		wp_enqueue_script(
			...
			plugins_url( 'assets/js/admin_set_options_by_category.js', ALLERGENS_DIETARY_PRO_FILE ),
			array( 'jquery' ),
			false,
			true
		);
	...
	public function upload_language_file() {
		...
		$language_file_basename = 'allergens-dietary-pro';
		...
		foreach ( $files_templates as $files_template ) {
			...
			$plugin_language_file   = ALLERGENS_DIETARY_PRO . '/languages/' . $language_file_fullname;
	...
	public static function insert_standard_data()
	{
		...
		if ($exists > 0) {
			...
			Allergens_Dietary_Pro_Allergen_Queries::includeItems();
		}
