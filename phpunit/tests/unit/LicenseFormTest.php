...
final class LicenseFormTest extends TestCase
{
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Ictoria_License_Form', 'showForm'));
    }

    public function test_construct_is_public()
    {
        $reflector = new ReflectionClass('Allergens_Dietary_Ictoria_License_Form');
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Ictoria_License_Form', 'submit'));
    }
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Ictoria_License_Form', 'sanitize'));
    }
